...
const FishRegistrationSchema =
    ...
    totalLength: Yup
        .number()
        .test('is-positive', 'O comprimento total deve ser um número positivo', value => value > 0)
    ...
    releaseWeight: Yup
        .number()
        .test('is-positive', 'O peso de soltura deve ser um número positivo', value => value > 0)
    ...
    standardLength: Yup
        .number()
        .test('is-positive', 'O comprimento padrão deve ser um número positivo', value => value > 0)
